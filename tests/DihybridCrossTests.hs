...
prop_required_cause_for_green_phenotype =
    Set.member green $ eval_causalmodel [allele_G :: Evidence String Bool, both_bb] cause_green

prop_only_G_allele_not_enough_to_conclude_green_phenotype =
    not (Set.member green $ eval_causalmodel [allele_G :: Evidence String Bool] cause_green)
